  ...
  .popover-wrapper {
    .popover-content {
      ...
      .menu-item {
        a {
          margin: 0;
          color: ${themeGet("colors.primary.alternate", "#8324ca")};
          padding: 12px 30px;
...
export const SelectedType = styled.button`
  ...
  padding-top: 0;
  padding-bottom: 0;
  padding-left: ${themeGet("space.3", "16")}px;
  padding-right: ${themeGet("space.3", "16")}px;
  ...
  .drawer_menu_item {
    ...
    .logoutBtn {
      ...
      &.current-page {
        ...
        font-weight: ${themeGet("fontWeights.bold", "700")};
        &:before {
          background-color: ${themeGet("colors.primary.regular", "#652e8d")};
        }
      }
    }
  }
